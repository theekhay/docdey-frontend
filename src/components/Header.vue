  ...
  <div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner">
      ...
      <ul class="nav navbar-nav navbar-left in">
        <li>
          <a href="#" class="menu-toggler sidebar-toggler font-size-20">
      ...
      <!-- <ul class="nav navbar-nav navbar-left in">
        <li class="dropdown dropdown-extended dropdown-notification">
          <a
            href="javascript:;"
            class="dropdown-toggle app-list-icon font-size-20"
          ...
          <ul class="dropdown-menu app-icon">
            <li class="app-dropdown-header">
              <p>
                <span class="bold">Applications</span>
              </p>
            </li>
            <li>
              <ul
      ...
      <div class="top-menu">
        <ul class="nav navbar-nav pull-right">
          ...
          <!-- bring this back up when you want to add chat -->
